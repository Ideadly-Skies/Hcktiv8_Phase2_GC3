...
func InitDB(){
	...
	if password == "" {
		log.Fatalf("Environment variable PASSWORD is not set")
	}

	// parse the config
	connStr := fmt.Sprintf("postgresql://postgres.bwbhnlivrbreoqhrlreg:%s@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres", password)
